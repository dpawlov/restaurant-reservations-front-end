    ...
    ngOnInit(): void {
      this.calendarOptions = {
        ...
        eventClick: (eventClickInfo) => {
          const reservationProps = eventClickInfo.event.extendedProps as any;
          const reservationUserId = reservationProps['userId']; 
          const currentUserId = this.authService.getUserId();
          if (currentUserId === undefined || reservationUserId !== currentUserId) {
            this.snackBar.open(
